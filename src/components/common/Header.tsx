            ...
            {isAuthenticated && user ? (
              <div className="relative" ref={userMenuRef}>
                <button
                  ...
                  className="flex items-center gap-1.5 sm:gap-2 pl-1 sm:pl-1.5 pr-2 sm:pr-3 py-1 rounded-xl bg-blue-50 border border-blue-200 hover:border-[#1A4B8C] transition text-left cursor-pointer group shadow-xs"
                >
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-[#1A4B8C] text-white flex items-center justify-center font-bold text-xs shadow-xs shrink-0">
                ...
                {userDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-xl border border-[#CFD8DC] p-2 z-50 animate-in fade-in zoom-in-95">
                    ...
                    <button
                      ...
                      className="w-full text-left px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-100 rounded-lg transition flex items-center justify-between cursor-pointer"
                    >
                      <div className="flex items-center gap-1.5">
              ...
              <button
                ...
                className="hidden xs:flex items-center gap-1.5 px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl bg-[#1A4B8C] hover:bg-[#0D3470] text-white text-xs font-bold transition-all duration-150 shadow-xs hover:shadow-md cursor-pointer active:scale-95 shrink-0"
              >
