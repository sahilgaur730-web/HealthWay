...
| M2 | Navigation Hub, Auth & Shared Hubs | Features 8-20 (Role navigation, ABHA login, Diagnostics, Referrals, Queue, Medicines, Emergency SOS) | M1 | PLANNED |
| M3 | Patient Portal & ASHA Community Module | Features 21-30 (Patient dashboard, vitals, appointments, PHR, triage; ASHA dashboard, registration, high-risk, voice intake) | M1, M2 | PLANNED |
| M4 | Doctor Teleconsultation & District Admin | Features 31-37 (Doctor dashboard, OPD queue, video room, Rx writer; Admin overview, outbreaks, drug inventory, ABDM interop) | M1, M2 | PLANNED |
